...
def tautau_trigger_weight(
    ...
    **kwargs,
    ...
    tt_trigger_passed = ak.zeros_like(events.channel_id, dtype=np.bool_)
    ttj_trigger_passed = ak.zeros_like(events.channel_id, dtype=np.bool_)
    # ttv_trigger_passed = ak.zeros_like(events.channel_id, dtype=np.bool_)
...
def emu_trigger_weight(
    ...
    **kwargs,
    ...
    mu_trigger_passed = ak.zeros_like(events.channel_id, dtype=np.bool_)
    e_trigger_passed = ak.zeros_like(events.channel_id, dtype=np.bool_)
    for trigger in self.config_inst.x.triggers:
