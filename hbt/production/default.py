...
from hbt.production.create_pdf_input_vars import create_pdf_input_vars
...
@producer(
    uses={
        ...
        IF_DATASET_HAS_LHE_WEIGHTS(normalized_pdf_weight, normalized_murmuf_weight), create_pdf_input_vars,
...
def default(self: Producer, events: ak.Array, **kwargs) -> ak.Array:
    ...
    if self.dataset_inst.is_mc:
        ...
        events = self[create_pdf_input_vars](events, **kwargs)
