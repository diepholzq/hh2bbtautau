...
from hbt.production.pdf_input_vars_reco import create_pdf_input_vars_reco_top
...
@producer(
    uses={
        ...
        normalized_murmuf_weight), create_pdf_input_vars_reco_top, create_pdf_input_vars_reco_higgs,
